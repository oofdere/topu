...
- [src/topu.langium](src/topu.langium) -  The grammar definition of your language
- [src/topu-module.ts](src/topu-module.ts) - The dependency injection module of your language implementation. Use this to register overridden and added services.
- [src/topu-validator.ts](src/topu-validator.ts) - An example validator. You should change it to reflect the semantics of your language.
...
- [src/syntaxes/topu.monarch.ts](src/syntaxes/topu.monarch.ts) - Monarch based syntax highlighting instructions.
- [syntaxes/topu.tmLanguage.json](syntaxes/topu.tmLanguage.json) - Textmate based syntax highlighting instructions.
